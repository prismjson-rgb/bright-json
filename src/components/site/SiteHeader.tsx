  ...
  return (
    <header className="sticky top-0 z-20 border-b border-white/10 bg-[#07111b]/90 backdrop-blur-sm">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 py-4">
        ...
        <Link
          href="/"
          className={`text-lg font-semibold tracking-tight text-white ${linkBase}`}
        >
          JSON Prism
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm text-slate-300">
          ...
          <Link
            href="/"
            className="rounded-full bg-cyan-300 px-4 py-2 text-sm font-medium text-slate-950 transition-transform hover:-translate-y-0.5 focus-visible:ring-2 focus-visible:ring-cyan-300/60 focus-visible:outline-none"
          >
            Open App
          </Link>
        </nav>
        ...
        <div className="flex md:hidden items-center gap-2">
          <Link
            href="/"
            className="rounded-full bg-cyan-300 px-4 py-2 text-sm font-medium text-slate-950 focus-visible:ring-2 focus-visible:ring-cyan-300/60 focus-visible:outline-none"
          >
            Open App
          </Link>
          <button
