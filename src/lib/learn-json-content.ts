...
export const TUTORIAL_SECTIONS: TutorialSection[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    content: "JSON stands for JavaScript Object Notation. It is a lightweight, text-based format for storing and exchanging data between systems. Standardized as ECMA-404 and RFC 8259, JSON is widely used by web APIs. A JSON text can contain an object, array, string, number, boolean, or null.",
