...
for (const file of ["404.html", "sitemap.xml", "robots.txt", "_headers", "manifest.json", "deployment.json", ".well-known/api-catalog", "openapi.json", "api.md", "auth.md"]) assert.ok(existsSync(`out/${file}`), `Missing ${file}`);
